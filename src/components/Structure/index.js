      ...
      <header className="relative pb-36">
        ...
        <Popover as="div" className="relative z-10">
          {({ open }) => (
            <>
              <nav
                className="relative flex items-center justify-between px-4 pt-6 pb-2 mx-auto max-w-7xl sm:px-6 lg:px-8"
                aria-label="Global"
              >
                <div className="flex items-center flex-1">
                  ...
                  <Link
                    ...
                    <div className="flex items-center mr-4 lg:hidden">
                      <Popover.Button className="inline-flex items-center justify-center p-2 text-white bg-opacity-0 rounded-md ">
                        <span className="sr-only">Open main menu</span>
                        <MenuIcon className="w-12 h-12" aria-hidden="true" />
                      </Popover.Button>
                    </div>
                  </div>
                  <div className="hidden space-x-10 lg:flex lg:ml-10">
                    {navigation.map((item) => (
                        <div className="mlinkitem">
                      <Link
                        key={item.name}
                        to={item.href}
                      >
              ...
              >
                ...
                >
                  <div className="w-full p-20 overflow-hidden border-gray-100 shadow-lg bg-black-gradient border-1 ">
                    <div className="flex items-center justify-between px-5 pt-4">
                      ...
                      <div className="-mr-2">
                        <Popover.Button className="inline-flex items-center justify-center p-2 rounded-md">
