...
<div className="max-w-full px-10 py-10 pt-12 mx-auto sm:max-w-full sm:px-6 lg:pt-16 lg:px-8">
  <div className="xl:grid xl:grid-cols-3 xl:gap-8">
    ...
    <div className="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
      ...
      <div className="md:grid md:grid-cols-2 md:gap-8">
        <div>
          <h3 className="text-sm font-semibold tracking-wider text-gray-400">Company</h3>
          <ul className="mt-4 space-y-4">
  ...
  <div className="py-8 mt-12 border-t border-gray-200">
    <p className="text-base text-gray-400 xl:text-center">&copy; 2021 OAKwave, LLC. All rights reserved.</p>
  </div>
</div>
</footer>
</>
