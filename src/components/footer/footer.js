...
const Footer = ({showBelow}) => {
    ...
    return (
      ...
      <footer className="w-full rn-footer-area bg-black-gradient pt--90 pb--60" aria-labelledby="footer-heading">
...
<div className="footer-wrapper">
        ...
        <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-2 xl:gap-2">
            ...
            <div className="mt-8 xl:mt-0 wow fadeInDown" data-wow-delay="500ms" data-wow-duration="0.6s">
          ...
          <div className="pt-8 mt-8 border-t border-gray-200 md:flex md:items-center md:justify-between">
            <div className="flex space-x-6 md:order-2">
                                         <div className="mt_md--30 mt_sm--30 wow fadeInDown" data-wow-delay="500ms" data-wow-duration="0.6s">
