...
export default function Nav() {
  return (
    <Popover className="relative w-full bg-gradient">
      {({ open }) => (
        <>
                  ...
                  {({ open }) => (
                    <>
                      ...
                      >
                        <Popover.Panel
                          static
                          className="absolute z-10 w-screen max-w-xl px-2 mt-3 -ml-4 transform sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
                        >
                          <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="relative grid gap-6 px-5 py-6 w-300 bg-black-gradient sm:gap-8 sm:p-8">
                              {solutions.map((item) => (
                                <a
                                  key={item.name}
                                  href={item.href}
                                ...
                                >
                                  <item.icon className="flex-shrink-0 w-6 h-6 text-indigo-300 hover:text-white" aria-hidden="true" />
                                  <div className="ml-4">
                            ...
                            <div className="px-5 py-5 space-y-6 bg-black-gradient sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                              {callsToAction.map((item) => (
                                <div key={item.name} className="flow-root">
                                  <a
                                    href={item.href}
                                    className="flex items-center p-3 -m-3 text-base font-medium text-white rounded-md hover:bg-indigo-300"
                                  >
