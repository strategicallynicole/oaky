...
let l; let a; l = this,a = function (){
    "use strict"; let l = {}; let a = {}; try {
        ...
        let l; `function` === typeof i.hooks.addShims ? i.hooks.addShims(s) : (l = i.shims).push.apply(l,s)
    }),s
